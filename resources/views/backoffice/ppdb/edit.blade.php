    ...
    <div class="col-10 mx-auto">
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Perbarui PPDB</h3>
        </div>
        <div class="card-body">
          @include('flash::message', ['timer' => 10])

          <form method="POST" action="{{ sub_route('backoffice.ppdb.update', $ppdb) }}">
            @csrf
            @method('PUT')
              ...
              <div class="col-md-8">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <form-input
                        ...
                        date-picker
                        type="text"
                        initial-value="{{ old('start_date', $ppdb->started_at->format('d-m-Y')) }}"
                        @error('start_date')
                        :state="false"
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        value="{{ old('start_time', $ppdb->started_at->format('H:i')) }}">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <form-input
                        ...
                        date-picker
                        type="text"
                        initial-value="{{ old('end_date', $ppdb->ended_at->format('d-m-Y')) }}"
                        @error('end_date')
                        :state="false"
                        error-message="{{ $message }}"
                        @enderror
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        value="{{ old('end_time', $ppdb->ended_at->format('H:i')) }}">
                ...
                <div class="form-group">
                  ...
                  <form-input
                    ...
                    select-first-item
                    initial-value="{{ old('payment.provider', $ppdb->paymentDetails()['provider']) }}"
                    type="select"
                ...
                <div class="form-group">
                  ...
                  <form-input
                    ...
                    select-first-item
                    initial-value="{{ old('payment.payment_type', $ppdb->paymentDetails()['payment_type']) }}"
                    type="select"
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    value="{{ old('payment.provider_number', $ppdb->paymentDetails()['provider_number']) }}">
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    value="{{ old('payment.provider_holder_name', $ppdb->paymentDetails()['provider_holder_name']) }}">
                ...
                <dynamic-form-input
                  :max="2"
                  :initial-values='@json(Arr::wrap(old('contact_persons', $ppdb->contactPersons())))'
